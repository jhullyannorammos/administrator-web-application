...
@WebServlet(urlPatterns = { "/Mercadorias" })
	...
	private void findAll(HttpServletResponse response) throws Exception {
		try {
			...
			for(Mercadoria mercadoria : mercadoriaPersistence.findAll()) {
				...
				mercadoriaJSON.put("", mercadoria.getProduto().getModelo().getFornecedor());
				mercadoriaJSON.put("", mercadoria.getProduto().getModelo().getModelo());
				mercadoriaJSON.put("", mercadoria.getProduto().getProduto());
				mercadoriaJSON.put("", mercadoria.getProduto().getValor());
				mercadoriaJSON.put("", mercadoria.getEstoque().getEstoque().toString());
				mercadoriaJSON.put("", mercadoria.getEstoque().getModelo());
				mercadoriaJSON.put("", mercadoria.getEstoque().getId());
				mercadoriaJSON.put("", mercadoria.getId());
